...
/**
 * Email Template: Judge Removed
 * Location: templates/emails/judge_removed.php
 */
?>
<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <h2 style="color: #dc3545;">Judge Assignment Cancelled</h2>
    <p>Dear <strong><?= htmlspecialchars($recipient_name) ?></strong>,</p>
    <p>Your assignment as a <strong>Judge</strong> has been cancelled for the following event:</p>
