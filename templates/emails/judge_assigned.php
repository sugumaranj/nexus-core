...
/**
 * Email Template: Judge Assigned
 * Location: templates/emails/judge_assigned.php
 */
?>
<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <h2 style="color: #198754;">Judge Assignment</h2>
    <p>Dear <strong><?= htmlspecialchars($recipient_name) ?></strong>,</p>
    <p>You have been assigned as a <strong>Judge</strong> for the following event:</p>
    ...
    <p>Please log in to your dashboard to view the evaluation criteria and submit scores during the event.</p>
